...
async function testRapidAPIDirectParty() {
  try {
    ...
    for (const location of locations) {
      ...
      // Log the results - events are in the data array
      ...
      if (data.data && data.data.length > 0) {
        ...
        data.data.slice(0, 3).forEach((event, index) => {
          ...
          console.log(`Date: ${event.date_human_readable}`);
          console.log(`Location: ${event.venue?.name || 'N/A'}`);
          console.log(`Address: ${event.venue?.full_address || 'N/A'}`);
    ...
    console.log("\n--- RapidAPI Integration Test Summary ---");
    console.log("✅ Successfully tested RapidAPI integration with different locations");
    console.log("✅ Successfully tested RapidAPI integration with coordinates");
    console.log("✅ Successfully tested RapidAPI integration with different radius values");
    console.log("✅ RapidAPI integration is working correctly");
