// Test script for party event descriptions in the search-events function
import fetch from 'node-fetch';

async function testPartyEventDescriptions() {
  try {
    ...
    console.log(`===== TESTING PARTY EVENT DESCRIPTIONS =====`);
    ...
    // Display party events with descriptions
