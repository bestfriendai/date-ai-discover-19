...
export async function searchEvents(params) {
  try {
    ...
    if (params.location) {
      // Always use "events in" for better results
    ...
    // Always use 'month' to get more events
    ...
    queryParams.append('limit', '200'); // Request 200 events to have enough after filtering
